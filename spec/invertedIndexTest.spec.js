const invertedIndex = require('../src/InvertedIndex');
...
describe('Inverted index Suite', () => {
  ...
  beforeAll(() => newIndex.createIndex('books', books));

  describe('Class Inverted Index', () => it('should be a class', () => {
  ...
  () => it('should have an Index created', () => expect(newIndex
  .index.books).toBeDefined()),
  ...
  () => it('should have searchIndex method accessible in the class', () => {
    ...
    it('should return an empty {object} if no query is found', () => {
      ...
      expect(Object.keys(newIndex
       .searchIndex('Checkpoint', 'books')).length).toBe(1);
    }),
